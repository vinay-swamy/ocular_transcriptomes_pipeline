...
combine_allTissues <- function(event, outfile_inclvl,outfile_medcts){
    ...
    if(event=='MXE.MATS.JC.txt') {write_tsv(data.frame(event_header[[event]]),outfile_inclvl); return(0)}
